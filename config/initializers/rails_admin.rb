# RailsAdmin config file. Generated on August 18, 2013 09:13
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Nflpool', 'Admin']
  ...
  config.model 'Pick' do
    ...
    # You can copy this to a 'rails_admin do ... end' block inside your pick.rb model definition
