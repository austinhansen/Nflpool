...
class PicksControllerTest < ActionController::TestCase
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post :create, pick: { date: @pick.date, pick_team_id: @pick.pick_team_id, user_id: @pick.user_id }
    end
  ...
  test "should update pick" do
    put :update, id: @pick, pick: { date: @pick.date, pick_team_id: @pick.pick_team_id, user_id: @pick.user_id }
    assert_redirected_to pick_path(assigns(:pick))
  end
